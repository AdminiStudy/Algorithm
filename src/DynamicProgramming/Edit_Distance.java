...
kitten 鈫� sitten (substitution of "s" for "k")
sitten 鈫� sittin (substitution of "i" for "e")
sittin 鈫� sitting (insertion of "g" at the end).**/
...
public class Edit_Distance {
	...
	public static int minDistance(String word1, String word2) {
		...
		/*
		 * If second string is empty, the only option is to insert all characters of
		...
		for (int i = 0; i < len1; i++) {
			...
			for (int j = 0; j < len2; j++) {
				...
				if (c1 == c2) {
					...
					/*
					 * if two characters are different , then take the minimum of the various
					 * operations(i.e insertion,removal,substitution)
					 */
