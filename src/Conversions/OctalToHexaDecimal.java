...
public class OctalToHexaDecimal {
	 ...
	 * * @param The Octal Number + + * @return The Decimal number + +
	 */
	 ...
	 * * + + * @param The Decimal Number + + * @return The Hexadecimal number + +
	 */
	...
	public static void main(String args[]) {
		...
		String hex = DecimalToHex(decimal); // Pass the decimla number to function and get converted Hex form of the
											// number
